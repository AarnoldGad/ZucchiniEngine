...
#define ZE_VERSION_REV 4
#define ZE_VERSION_SPEC "alpha"
#define ZE_VERSION_MONTH 9
#define ZE_VERSION_DAY 6
...
#define CURRENT_SOURCE_LOCATION SourceLocation{__FILENAME__, static_cast<unsigned>(__LINE__), __func__ }
