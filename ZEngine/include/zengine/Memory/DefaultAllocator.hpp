 ...
 **/
#ifndef ZE_DEFAULTALLOCATOR_HPP
#define ZE_DEFAULTALLOCATOR_HPP

#include "zengine/zemacros.hpp"

#include "zengine/Memory/MemoryAllocator.hpp"

namespace ze
{
   class ZE_API DefaultAllocator : public MemoryAllocator
   {
   public:
      void* allocate(size_t size, SourceLocation const& location) override;
      size_t release(void* pointer, size_t size, SourceLocation const& location) noexcept override;
